...
const Home = () =>  (
  <main className="home__outer">
    ...
    <p>Dimensions weren't given so I built it for 1600 x 900 (the inner container is 1000px). It's not responsive, but it should play nice down to about 1050px. Breakpoints were included for posterity but not used because of time.</p>
    ...
    <p>And just for fun, a custom favicon to boot!</p>
  </main>
)
